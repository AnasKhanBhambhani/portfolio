...
interface IUseExportVisualizationParams {
  type: number;
  theme: TTheme;
}

export const useExportVisualization = ({type, theme}: IUseExportVisualizationParams) => {
  ...
  return {handleExportPNG, showExportToast, setShowExportToast};
};
