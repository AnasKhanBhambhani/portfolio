...
import { SECTION, TAG_HEAD, SEC_TITLE, GLASS_CARD } from "../ui";
      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-15 mb-10">
        <div>
          ...
          <Reveal as="p" delay={1} className={`${PARA} mb-4.5`}>
            ...
            that split between freelance and agency engagements shipping products for
          ...
          <Reveal as="p" delay={3} className={PARA}>
            ...
            knowledge of Node, Express and NestJS and REST or GraphQL APIs, from freelance
        ...
        <Reveal
          delay={1}
          className="relative aspect-4/5 max-w-100 mx-auto lg:max-w-none lg:aspect-auto lg:min-h-full lg:mx-0"
        >
          <div className="absolute -inset-2.5 rounded-4xl bg-linear-to-br from-primary/30 to-violet/20 blur-xl opacity-60" />
          <div className="absolute inset-0 rounded-[28px] overflow-hidden border border-white/12 bg-card-2 shadow-[0_30px_70px_rgba(0,0,0,0.5)]">
            <img
              src="/anas.jpg"
              alt="Muhammad Anas"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {FACTS.map((fact, i) => (
          <Reveal
            key={fact.k}
            delay={(i % 4) + 1}
            className={`${GLASS_CARD} p-5.5 hover:-translate-y-1.25 hover:border-accent/40`}
          >
